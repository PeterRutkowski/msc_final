...
x_train = np.load('pipeline_data/comp240_dbscan200/rep_x_train_none_none.npz',
...
for degree in [1, 2, 3]:
    ...
    for test_set in ['x_test_none_none',
        ...
        score = clf.score(np.load('pipeline_data/comp240_dbscan200/rep_{}.npz'.format(test_set),
